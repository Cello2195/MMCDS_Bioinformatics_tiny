...
\begin{figure*}[ht!]
    \centering
    \includegraphics[width=0.9\linewidth]{pic/fig_methods.pdf}
...
\begin{figure*}[ht!]
    \centering
    \includegraphics[width=0.9\linewidth]{pic/fig3.pdf}
...
\begin{figure*}[ht!]
    \centering
    \includegraphics[width=0.9\linewidth]{pic/fig4.pdf}
...
As illustrated in the first confusion matrix, the first training strategy achieves an accuracy score of 0.77, effectively eliminating a large proportion of ineffective cases while preserving a substantial fraction of positive candidates (Fig.~\ref{fig:3}a). Such a result demonstrates its robustness in distinguishing interacting from non-interacting compounds. Moreover, the second training strategy achieves a perfect recall score of 1.00 during the test phase (Fig.~\ref{fig:3}b). We present the prediction confidence level of all 19 test molecules (Fig.~\ref{fig:3}c). Not only are all 19 true effective cases sorted out, but 11 of them are also recalled with confidence greater than 0.6, exhibiting superior sensitivity. 
...
\begin{figure*}[ht!]
    \centering
    \includegraphics[width=0.9\linewidth]{pic/fig5.pdf}
