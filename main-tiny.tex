...
We then performed biological validation to determine whether the computationally selected candidates exert measurable effects on MEIOB and the MEIOB--SPATA22 axis. This section includes validation of interaction disruption, assessment of MEIOB nuclear localization, evaluation of MEIOB expression in C33A cells, and examination of downstream cellular phenotypes such as proliferation and migration.
